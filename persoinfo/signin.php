          ...
          <div class="form-field password-field">
            ...
            <div class="input-with-icon">
              ...
              <label for="show-pwd-1" class="show-pwd-label" aria-label="Afficher le mot de passe">
                <svg class="icon-eye" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg>
                <svg class="icon-eye-off" viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17.94 17.94A10.94 10.94 0 0 1 12 20c-7 0-11-8-11-8a19.79 19.79 0 0 1 5.06-5.94M9.9 4.24A10.94 10.94 0 0 1 12 4c7 0 11 8 11 8a19.69 19.69 0 0 1-2.16 3.19M14.12 14.12A3 3 0 0 1 9.88 9.88"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
              </label>
            </div>
          </div>
          ...
          <div class="form-row">
            <div class="form-field">
              ...
              <input
                ...
                value="<?php echo htmlspecialchars($form['field']); ?>"
                required />
            </div>
            ...
            <div class="form-field">
              ...
              <input
                ...
                value="<?php echo htmlspecialchars($form['university']); ?>"
                required />
            </div>
          </div>
